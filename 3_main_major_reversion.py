...
from evaluation import evaluate, evaluate_embedding_tsne, evaluate_confusion
...
def run(args):
    ...
    print('3.在测试集上评估最终模型')
    # test_coarse_acc, test_coarse_f1, test_fine_acc, test_fine_f1 = evaluate_embedding_tsne(model, G_test, device, args)
    test_coarse_acc, test_coarse_f1, test_fine_acc, test_fine_f1 = evaluate_confusion(model, G_test, device, args)
